...
# data_path = Path(Path('.').absolute().parent.parent.parent.parent,'data')
=======
>>>>>>> 3cab657c921c9b883388996cebcb50b48f4ebe38
...
race_path = os.path.join(data_path, 'bbrion', 'data', 'race_sex_dummy.json')

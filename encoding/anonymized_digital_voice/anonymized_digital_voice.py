...
def encode(tests:list):
    ...
    #id_list = [key for key in data_json(adv_path)] # for testing when json can't be loaded from the cloud
    ...
    anonymized_digital_voice_json = data_json(adv_path)
    result = {}
    
    for i in dummy_list:
        resp = anonymized_digital_voice_json[i]
        #print(resp)

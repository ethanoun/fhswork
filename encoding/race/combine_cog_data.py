...
def encode(tests:list):
    ...
    id_list = [key for key in data_json(race_path)] #use when unable to access the requried json file
    ...
    for i in dummy_list:
        ...
        for idx, j in enumerate(sets):
            ...
            if 'unkno' in resp['race1']: # race returns none if it is not available/unkown
                resp['race1'] = None     
